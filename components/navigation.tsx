  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-white/95 backdrop-blur-md border-b border-border shadow-sm" : "bg-transparent backdrop-blur-sm"
      }`}
    >
        ...
        <div className="flex justify-between items-center h-25">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="w-24 h-24 rounded-lg overflow-hidden flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              <Image src="/logo.png" alt="Loopera Logo" width={96} height={96} className="object-contain" />
            </div>
          </Link>
