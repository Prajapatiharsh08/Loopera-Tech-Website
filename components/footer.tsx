        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='space-y-6'>
            ...
            <p className='text-gray-300 leading-relaxed'>
              We craft scalable, AI-first digital solutions that help you
              automate, grow, and lead in your industry.
            </p>
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <span className='text-gray-300'>+91 82184-85785</span>
              </div>
              <div className='flex items-center space-x-3'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
          <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
            <p className='text-gray-400 text-sm'>
              ...
              <span className='block sm:inline'>
                ...
                <a
                  ...
                  className='text-[#1E90FF] font-medium hover:underline transition-colors duration-300'
                >
                  HBJ Syndicate
                </a>
              </span>
            ...
            <div className='flex space-x-6 text-sm'>
              <Link
                href='/privacy'
                className='text-gray-400 hover:text-[#1E90FF] transition-colors duration-300'
              >
                Privacy Policy
              </Link>
              <Link
