...
const projects = [
  {
    ...
    description: "Built a smart recommendation engine that increased conversion rates by 40% for a retail client.",
  ...
  },
  {
    ...
    description: "Developed a comprehensive patient management system with automated scheduling and AI diagnostics.",
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">FEATURED WORK</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover how we've helped businesses transform their digital presence with intelligent solutions
          </p>
        </div>
        ...
        <div className="text-center">
          <Link href="/portfolio">
            <Button
              size="lg"
              className="bg-gradient-to-r from-[#1E90FF] to-[#6FBFFF] hover:from-[#1E90FF]/90 hover:to-[#6FBFFF]/90 text-white px-8 py-4 rounded-full font-semibold group cursor-pointer"
            >
              CHECK PORTFOLIO
